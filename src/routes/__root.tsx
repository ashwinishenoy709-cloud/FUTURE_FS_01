  ...
  head: () => ({
    meta: [
      ...
      { title: "Ashwini Shenoy — Software Developer Portfolio" },
      {
        name: "description",
        content:
          "Portfolio of Ashwini Shenoy — Computer Science undergraduate building web applications, browser extensions and cybersecurity tools.",
      },
      { name: "author", content: "Ashwini Shenoy" },
    ...
    links: [
      ...
      { rel: "icon", href: "/ashwini-logo23.png", type: "image/png" },
    ],
  }),
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="bg-poly flex min-h-screen flex-col bg-transparent">
        <SiteHeader />
